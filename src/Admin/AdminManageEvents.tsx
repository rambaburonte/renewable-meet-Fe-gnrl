    ...
    <div className="min-h-screen flex bg-black text-white">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-xl border border-green-700 mb-8">
          <h2 className="text-xl text-green-300 font-semibold mb-4">Add New Session</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <textarea
              ...
              className="bg-black border border-green-600 px-4 py-2 rounded-md text-white md:col-span-2"
              value={description}
